...
public class Issue248Test {
    ...
    public Issue248Test(MavenRuntimeBuilder runtimeBuilder)
            throws Exception {
    ...
    public void testPluginWithActiviti() throws Exception {
        File projectDirTransformed = new File(
                "target/test-classes/transformed-projects/issue-248"
        );
        ...
        File projDir = resources.getBasedir("issue-248");
        ...
        verifier
                ...
                .withCliOption("-DoutputName=cliname")
                .withCliOption("-X") // debug
                .withCliOption("-B")
                .execute("clean", "verify")
                .assertErrorFreeLog();

        assertFileContains(projDir, "target/cliname.xml", "junit");
    }
